    ...
    <div className="grid w-[80%] mx-auto pt-[5rem] grid-cols-1 lg:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <p className="text-white opacity-65 text-[15px] mt-[1rem]">
          ...
          corporis vero tempora unde quis atque consequatur exercitationem.
          Perferendis recusandae deleniti, labore itaque animi illum quas dolor
          enim ratione consectetur repellendus quibusdam atque numquam? Saepe,
